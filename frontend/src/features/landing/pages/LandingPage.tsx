...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased flex flex-col">
      ...
      {/* Hero Section */}
      <section className="pt-28 pb-20 px-4 sm:px-6 max-w-7xl mx-auto text-center space-y-8 flex-1">
        <div className="space-y-4 max-w-3xl mx-auto">
          <Badge
            variant="purple"
            className="px-3.5 py-1 text-xs font-semibold uppercase tracking-wider inline-flex items-center gap-1.5"
          >
          ...
          <p className="text-base sm:text-lg text-slate-600 font-normal leading-relaxed max-w-2xl mx-auto">
            Replace disconnected WhatsApp chats, emails, and phone calls. Assign tickets to support
            agents, track response times in real time, and monitor team performance.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          <Link to="/login">
            <Button
              variant="primary"
              className="bg-slate-900 hover:bg-slate-800 text-white font-semibold text-base px-8 py-3 rounded-xl shadow-lg"
            >
          ...
          <a href="#workflows">
            <Button
              variant="outline"
              className="font-semibold text-base px-6 py-3 rounded-xl border-slate-300 text-slate-700 hover:bg-white shadow-sm"
            >
              See How It Works
            </Button>
          </a>
      ...
      <section id="workflows" className="py-20 bg-white border-t border-b border-slate-200/80 px-6 scroll-mt-20">
        <div className="max-w-7xl mx-auto space-y-12 text-center">
          <div className="max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-sm text-slate-500 font-normal">
              Whether you manage a team, handle tickets, or request support, SupportFlow provides
              role-scoped tools.
            </p>
          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">
                      Business Admin Control Center
                    </h3>
                    <p className="text-xs text-slate-500">
                      Central management of business operations & team productivity
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-700 font-medium">
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Send single-use email invitation links to add agents up to your subscription
                      seat limit.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      View all customer support requests and assign them to specific agents based on
                      workload.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Manage plan quotas, upgrade to Standard (₹2,499/mo) or Business (₹6,499/mo),
                      and access Razorpay payment receipts.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Track total ticket volume, open queue items, resolution rates, and average
              ...
              <Card glass className="p-8 text-left space-y-6 border border-emerald-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Isolated queue and real-time live chat tools
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-700 font-medium">
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Agents strictly view tickets assigned to them by Business Admins for focused
                      productivity.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Communicate with customers in real time with live message delivery and typing
                      indicators.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Add confidential notes on tickets that are strictly hidden from customers.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Receive FCM browser push alerts immediately when a new ticket is assigned to
                      you.
                    </p>
                  </div>
                </div>
              ...
              <Card glass className="p-8 text-left space-y-6 border border-amber-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Simple ticket submission & real-time messaging
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-700 font-medium">
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Submit requests with category, priority, description, and target business
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Monitor status changes from Open to In Progress, Resolved, or Closed in real
                      time.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Send replies directly to assigned support agents with real-time updates.
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      View persistent in-app notifications whenever an agent responds or resolves
                      your ticket.
                    </p>
                  </div>
                </div>
              ...
              <Card glass className="p-8 text-left space-y-6 border border-purple-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-700 font-medium">
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                    ...
                    <p className="text-slate-500">
                      Track active subscriptions across Free, Standard, and Business tiers.
                    </p>
                  </div>
                </div>
              </Card>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 px-6 max-w-7xl mx-auto text-center space-y-12 scroll-mt-20">
        <div className="max-w-2xl mx-auto space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          ...
          <Card
            glass
            className="p-6 space-y-6 border border-slate-200/80 flex flex-col justify-between"
          >
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <span className="text-xs text-slate-500 font-medium"> / {billingCycle === 'yearly' ? 'forever' : 'month'}</span>
              </div>
              <ul className="space-y-2.5 text-xs text-slate-600 font-normal pt-2 border-t border-slate-100">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> 1 Support Agent seat
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Up to 25 Tickets / month
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Socket.IO Real-Time Chat
                </li>
              </ul>
            </div>
            <Link to="/login">
          ...
          <Card
            glass
            className="p-6 space-y-6 border border-indigo-600 shadow-xl ring-2 ring-indigo-600/20 flex flex-col justify-between bg-white"
          >
            <div className="space-y-4">
              ...
              <ul className="space-y-2.5 text-xs text-slate-600 font-normal pt-2 border-t border-slate-100">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Up to 5 Support Agent seats
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Unlimited Monthly Tickets
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Socket.IO Real-Time Chat
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Private Agent Internal Notes &amp; Reports
                </li>
              </ul>
            </div>
            <Link to="/login">
              <Button
                variant="primary"
                className="w-full bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs shadow-md"
              >
                Upgrade to Standard
              </Button>
            </Link>
          ...
          <Card
            glass
            className="p-6 space-y-6 border border-purple-200 flex flex-col justify-between bg-white"
          >
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <div>
              ...
              <ul className="space-y-2.5 text-xs text-slate-600 font-normal pt-2 border-t border-slate-100">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Up to 20 Support Agent seats
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Unlimited Monthly Tickets
                </li>
      ...
      <footer className="bg-slate-900 text-slate-400 text-xs py-12 px-6 border-t border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          ...
          <p>
            © {new Date().getFullYear()} SupportFlow. Centralized Customer Support Platform for
            Small Businesses.
          </p>
        </div>
      </footer>
