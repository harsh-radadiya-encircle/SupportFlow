    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased flex flex-col">
      ...
      <section id="pricing" className="py-20 px-6 max-w-7xl mx-auto text-center space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-3xl font-bold text-slate-900">
                $0 <span className="text-xs font-semibold text-slate-500">/ month</span>
              </p>
              <ul className="space-y-2.5 text-xs text-slate-600 font-normal pt-2 border-t border-slate-100">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> 1 Support Agent
                  seat
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Up to 25 Tickets /
                  month
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Real-Time Socket
                  Live Chat
                </li>
              </ul>
            </div>
          ...
          <Card
            glass
            className="p-6 space-y-6 border border-indigo-600 shadow-xl ring-2 ring-indigo-600/20 flex flex-col justify-between"
          >
            <div className="space-y-4">
              ...
              <p className="text-3xl font-bold text-slate-900">
                $29 <span className="text-xs font-semibold text-slate-500">/ month</span>
              </p>
              <ul className="space-y-2.5 text-xs text-slate-600 font-normal pt-2 border-t border-slate-100">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Up to 5 Support
                  Agent seats
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Unlimited Monthly
                  Tickets
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Private Agent
                  Internal Notes
                </li>
              </ul>
            </div>
          ...
          <Card
            glass
            className="p-6 space-y-6 border border-purple-200 flex flex-col justify-between"
          >
            <div className="space-y-4">
              <div>
              ...
              <p className="text-3xl font-bold text-slate-900">
                $79 <span className="text-xs font-semibold text-slate-500">/ month</span>
              </p>
              <ul className="space-y-2.5 text-xs text-slate-600 font-normal pt-2 border-t border-slate-100">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Up to 20 Support
                  Agent seats
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Unlimited Monthly
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Priority 24/7
                  Dedicated Support
                </li>
              </ul>
            </div>
